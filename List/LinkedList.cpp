...
template<class T>
int LinkedList<T>::Obt_tamano()
{
    return Size;
}

template <class T>
void LinkedList<T>::Copy_Ar(const LinkedList<T> &RHS)
{
...
template<class T>
void LinkedList<T>::Ingre_inicio(T Data)
{
    Node<T> *NewNode=new Node<T>(Data);
    if(Head==0)
    {
...
template<class T>
void LinkedList<T>::Ingre_final(T Data)
{
    Node<T> *NewNode=new Node<T>(Data);
    if(Head==0)
    {
...
template<class T>
void LinkedList<T>::Ingreso_en_posicion(T Data,int Index)
{
    Node<T> *NewNode=new Node<T>(Data);
    if(Index==1)
    {
...
template<class T>
void LinkedList<T>::Eliminar_primero()
{
    if(Head==0)
    {
...
template<class T>
void LinkedList<T>::Eliminar_ultimo()
{
    if(Head==0)
    {
        cout<<"\nEsta lista se encuentra vacia ...\n";
...
template<class T>
void LinkedList<T>::Eliminar_posicion(int Index)
{
    if(Head==0)
    {
        cout<<"\nEsta lista se encuentra vacia ...\n";
...
template<class T>
void LinkedList<T>::Vuelta_lista()
{
    Node<T>* Cur=Head;
    Node<T>* Pre=0;
    Node<T>* siguiente=0;
...
template<class T>
void LinkedList<T>::Vuelta_datos()
{
    T Array[Size];
    T Holder;
    Node<T> *Temp=Head;
...
template<class T>
void LinkedList<T>::Vuelta_lista(Node<T> *N)
{
...
template<class T>
void LinkedList<T>::Elimina_todos_Nodos()
{
    if(Head!=0)
    {
        cout<<"\n\nEliminando nodos...\n";
...
template<class T>
void LinkedList<T>::GetNth(int Index)
{
	Node<T> *Temp=Head;
	if(Temp==NULL)
	{
...
template<class T>
void LinkedList<T>::Encontrar_dat(T Data)
{
    Node<T> *Temp=Head;
    int i=1;
    int flag=0;
...
template<class T>
void LinkedList<T>::Eliminar_Dat(T Data)
{
    Node<T> *Cur=Head;
    Node<T> *Pre=0;
    int flag=0;
